...
public class JobIndexConsumer {
    ...
    @JmsListener(destination = "job.created.search.queue", containerFactory = "jmsListenerContainerFactory")
    ...
    @JmsListener(destination = "job.closed.search.queue", containerFactory = "jmsListenerContainerFactory")
