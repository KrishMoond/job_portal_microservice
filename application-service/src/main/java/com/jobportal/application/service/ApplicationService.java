...
public class ApplicationService {
    ...
    public List<JobApplication> getByJobId(String jobId) {
        return applicationRepository.findByJobId(jobId);
    }

    public List<JobApplication> getByCandidateId(String candidateId) {
        return applicationRepository.findByCandidateId(candidateId);
    }

    public JobApplication updateStatus(String applicationId, StatusUpdateRequest req) {
